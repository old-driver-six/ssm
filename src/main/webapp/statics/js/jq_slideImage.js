;(function(undefined) {
    ...
    function getRandomImg(imgArr) {
     ...
     return imgArr[parseInt(Math.random()*(imgArr.length))]
    }
    //元素设置css
    ...
    function getEleCssLeft($ele) {
        console.log(parseInt($ele.css('left')))
...
//          this.slideImage.crossOrigin = "Anonymous";
        ...
        initMouse:function () {
            ...
            _this.$slideDragBtn.on('mousedown',function (e) {
                ...
                console.log(e.pageX,positionDiv.left)
                var distenceX = e.pageX - positionDiv.left;
                $(document).mousemove(function (e) {
                    if(!ifThisMousedown){
                        return false;
                    }
                    var x = e.pageX - positionDiv.left -17;
                    if(x<0){
                        x=0;
