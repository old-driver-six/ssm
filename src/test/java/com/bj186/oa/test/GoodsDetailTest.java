...
import com.bj186.oa.mapper.GoodsDetailMapper;
import com.bj186.oa.mapper.UserMapper;
import com.bj186.oa.pojo.GoodsDetail;
...
public class GoodsDetailTest {
    ...
    public void selectUserByIdTest(){
        User user = sqlSession.selectOne("com.bj186.oa.mapper.UserMapper.selectUserById", 1l);
        System.out.println(user);
    }
    @Test
    public void selectGoodsDetail(){
        GoodsDetailMapper goodsDetailMapper = sqlSession.getMapper(GoodsDetailMapper.class);
        GoodsDetail goodsDetail = goodsDetailMapper.selectGoodsDetailById(1l);
